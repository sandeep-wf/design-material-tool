...
def load_data():
    try:
        # Updated to match actual Excel sheet names: Designs, Material, Mapping
...
if st.session_state.screen == 'Design Selection':
    ...
    if df_designs is not None:
        # Ensure we target the correct column index for Design Name and Code
